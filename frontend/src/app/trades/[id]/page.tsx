          ...
          <div className="card">
            ...
            <div className="p-5 space-y-3">
              ...
              {trade.state === 'VERIFIED' && payments.length > 0 && (() => {
                ...
                const otherPayment = payments.find(p => p.userId !== currentUserId);
                      ...
                      <div className="space-y-2">
                        <div className="flex items-center justify-between">
                          ...
                          <span className="text-sm font-semibold text-slate-900">
                            {Number(myPayment.amount).toFixed(2)} {myPayment.currency}
                          </span>
                        </div>
                        <div className="flex items-center justify-between">
                        ...
                        {myPayment.status !== 'succeeded' && myPayment.status !== 'refunded' && (
                          <button
                            ...
                            onClick={async () => {
                              ...
                              setActionError('');
                              try {
                                const result = await paymentsApi.createCheckout(myPayment.id);
                                if ('simulated' in result) {
                                  // Payment was auto-completed in simulation mode
                                  loadTrade();
